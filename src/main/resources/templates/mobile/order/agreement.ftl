...
<#include "../include/link.ftl">
    <link rel="stylesheet" href="${css("mobile/order_agreement.css")}">
</head>
<body>
<#include "../include/header.ftl">
<section class="wrapper" id="order_agreement" style="background-image: url(${image("mobile/common/porsche_bg.png")})"
         v-cloak>
    <div class="page-title">
        <img class="title-icon justify-center" src="${image("mobile/order/xieyi.png")})"//>
    ...
    <div class="content">
        <div class="line">
            <h1><span class="dot justify-center" style="background-image: url(${image("mobile/common/1.png")})"></span>阅读并确认购车意向书
        ...
        <p :class="isAgreePolicy?'btn-box agree-btn':'btn-box grey-btn'"><span class="btn" @touchstart="toAgreement" onclick="_hmt.push(['_trackEvent', '同意购车意向书_mobile', 'click', 'source=${source!}'])">我已阅读并同意以上条款</span>
        </p>
        <p class="warn"><span v-if="!isAgreePolicy">{{countdown}}</span> <span :class="isAgreePolicy?'hid-opacity':''"> 秒后可点击</span>
        </p>
    </div>
    </div>
</section>
